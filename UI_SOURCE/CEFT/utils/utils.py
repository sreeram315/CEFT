...
def cropImageInclusivity(imagePath, aspectRatio, salientCoordinates, top_feature, outputFileName = "output"):
	...
	if not all([isInsideCrop(m1_x, m1_y, crop), isInsideCrop(m2_x, m2_y, crop), isInsideCrop(m3_x, m3_y, crop), isInsideCrop(m4_x, m4_y, crop)]):
		...
		cropImage(imagePath, aspectRatio, top_feature, outputFileName)
		return
